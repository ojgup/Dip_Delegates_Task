...
namespace FileParserTests
{
    public class FileParserTests
    {
        ...
        private string _csvPath = Environment.GetEnvironmentVariable("HOME") + "/Users/Ojas/Documents/GitHub/Dip_Delegates_Task/data.csv";  // change to appropriate path
        private string _tsvPath = Environment.GetEnvironmentVariable("HOME") + "/Users/Ojas/Documents/GitHub/Dip_Delegates_Task/data.tsv";  // change to appropriate path

        private string _writeFile = Environment.GetEnvironmentVariable("HOME") + "/Users/Ojas/Documents/GitHub/Dip_Delegates_Task/data.txt";  // change to appropriate path
